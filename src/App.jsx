...
const tutors = [
  {
    ...
    verified: true,
    experience: "8 years",
    tagline: "CBSE/ICSE specialist for grades 8-12",
    languages: ["English", "Hindi"],
    category: "Academic Tutors",
    students: 240,
    responseTime: "20 mins",
    availability: ["Mon 6 PM", "Wed 7 PM", "Sat 11 AM"],
    about:
      "Helps school students strengthen concepts, improve problem solving, and prepare confidently for board exams with customized practice plans.",
  },
  {
    id: 2,
    name: "Rahul Verma",
